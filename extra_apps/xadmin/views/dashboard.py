...
class UserWidgetAdmin(object):
    ...
    list_display = ('widget_type', 'page_id', 'home')
    list_filter = ['home', 'widget_type', 'page_id']
...
class Dashboard(CommAdminView):
    ...
    def get_context(self):
        new_context = {
            ...
            "?home=%s&page_id=%s&_redirect=%s" % (self.user.id, self.get_page_id(), urlquote(self.request.get_full_path()))
        }
